 ...
 */
sealed class RetrofitStatePagedList<out T> {

    data class Success<T>(val value: T) : RetrofitStatePagedList<T>()
    object Loading : RetrofitStatePagedList<Nothing>()
    object NoData : RetrofitStatePagedList<Nothing>()
    object EmptyData : RetrofitStatePagedList<Nothing>()
    object CantLoadMore : RetrofitStatePagedList<Nothing>()
    data class Error(val message: String, val exception: Exception?=null, val throwable: Throwable) : RetrofitStatePagedList<Nothing>()
    data class ApiError(val responseCode: Int, val errorBody: ResponseBody?) : RetrofitStatePagedList<Nothing>(){
