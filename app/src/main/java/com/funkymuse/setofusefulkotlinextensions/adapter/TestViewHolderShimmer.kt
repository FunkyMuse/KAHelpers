...
import com.funkymuse.kotlinextensions.views.setPrecomputedText
...
class TestViewHolderShimmer(private val binding: CustomizableCardViewBinding) :
    ...
    fun bind(item: TestModel) {
        ...
        binding.image.setImageResource(com.funkymuse.setofusefulkotlinextensions.customviews.R.drawable.pin_code_highlight_state)
